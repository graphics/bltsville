...
/*
 * To extend the dither or scale types, define BVDITHER_EXTERNAL_INCLUDE
 * and/or BVSCALE_EXTERNAL_INCLUDE, which contain the additional enumerations
...
#define BVDITHERDEF_HALFTONE	(0x01 << BVDITHERDEF_TECHNIQUE_SHIFT)
...
enum bvdithermode {
	...
	BVDITHER_FASTEST_ON =	BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_FASTEST |
				BVDITHERDEF_ON,
	BVDITHER_FASTEST_HALFTONE = BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_FASTEST |
				BVDITHERDEF_HALFTONE,
	...
	BVDITHER_GOOD =		BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_GOOD |
				BVDITHERDEF_ON,
	BVDITHER_GOOD_HALFTONE = BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_GOOD |
				BVDITHERDEF_HALFTONE,
	...
	BVDITHER_BETTER =	BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_BETTER |
				BVDITHERDEF_ON,
	BVDITHER_BETTER_HALFTONE = BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_BETTER |
				BVDITHERDEF_HALFTONE,
	...
	BVDITHER_BEST =		BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_BEST |
				BVDITHERDEF_ON,
	BVDITHER_BEST_HALFTONE = BVDITHERDEF_VENDOR_ALL |
				BVDITHERDEF_BEST |
				BVDITHERDEF_HALFTONE,
...
#define BVSCALEDEF_TYPE_SHIFT 16
/* 0 don't know */
...
enum bvscalemode {
	...
	BVSCALE_NEAREST_NEIGHBOR = BVSCALEDEF_VENDOR_GENERIC + 0,
...
struct bvbltparams {
	...
	unsigned long batchhandle;	/* (i/o) handle for associated batch;
						 returned when
						 BVFLAG_BATCH_BEGIN set;
						 provided to subsequent BLTs
						 with BVFLAG_BATCH_CONTINUE */

	void (*callbackfn)(unsigned long);	/* (i) callback function when
						       BVFLAG_ASYNC is set */
